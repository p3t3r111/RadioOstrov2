...
@section('content')
    {{-- Welcome --}}
    <section class="pt-12 hero hero-img max-h-[80vh] lg:min-h-[60vh] flex flex-col justify-center items-center  p-12 gap-2 "
        ...
        <div class="hero-body">
            <div class="flex flex-col items-center gap-2 mt-6"> {{--  mt-28 --}}
                ...
                <h2 class="flex flex-col lg:block text-xl text-center md:text-3xl lg:text-4xl title text-white">Vítame vás na
