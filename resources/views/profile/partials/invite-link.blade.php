<div class="">
    ...
    <div class="flex gap-4">
        ...
        @if ($user->hasCustomReferralLink())
            <form method="post" action="{{ route('profile.update.referallink') }}" class="relative w-full lg:max-w-[60%] flex-1">
                @csrf
                <input
                    ...
                    type="text" value="{{ $user->referral_code }}" maxlength="255" min="4" name="referral_code" required>
                <button
