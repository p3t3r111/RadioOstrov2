<div class="">
    ...
    <div class="relative w-full lg:max-w-[60%]">
        ...
        <button
            class="copy-btn absolute right-2 top-1/2 -translate-y-1/2 rounded bg-gray-200 px-2 py-1 text-sm font-semibold text-gray-700 hover:bg-gray-300"
            data-copy="{{ url('/r/' . $invite_code) }}">
            <p class="hidden md:block">Kopírovať odkaz</p>
