<nav id="navbar" class="navbar fixed flex justify-center items-center bg-white w-full h-14 z-50 shadow-lg" id="mainNav" role="navigation"
    ...
    <div class="flex justify-between items-center absolute w-full">
        <div class="navbar-brand flex justify-between px-2 lg:pl-6 w-full items-center " id="mainNavBrand">
            <a class="navbar-item flex items-center" href="{{ route('index') }}">
                <img src="{{ asset('assets/logo.png') }}" id="logoFly" class="h-8 w-8 mr-2" alt="Logo školy : Stredná odborná škola informačných technológií, Ostrovského 1, Košice">
                <h1 class="title pageTitle uppercase text-sm lg:text-lg font-bold">
                    Rádio Ostrov</h1>
            </a>

            <a role="button" class="navbar-burger block lg:hidden" aria-label="menu" aria-expanded="false" data-target="mainNavBar" id="hamburger">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                  <path id="hamburger-open" class="block" stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                  <path id="hamburger-close" class="hidden" stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                </svg>
            </a>
        </div>
        ...
        <div id="mainNavBar" class="navbar-menu hidden lg:block">
          <div class="navbar-end flex items-center gap-6 uppercase">
              ...
              <a class="flex items-center gap-1 capitalize min-w-20 mr-2" onmouseover="showDropdown()" href="{{ route('profile.show') }}">
        ...
        <div class="flex flex-col navbar-item has-dropdown absolute right-0 min-w-40" id="userProfile" onmouseleave="hideDropdown()">
          <div class="navbar-dropdown flex flex-col gap-2 bg-white rounded-b-lg mt-10 hidden item" id="dropdown" >
