...
@section('content')
    ...
    <div class="flex flex-col items-center grow gap-4 w-[80%]">
      ...
      <form action="{{ route('admin.denyUsersSongsPost') }}" method="post" class="flex items-center justify-center">
      @csrf
      <input type="hidden" name="songId" value="{{ $song['songId'] }}">
      <button type="submit" title="Zamietnuť pesničku" class="flex-3 min-h-[9.5rem] bg-red-400 rounded-r-2xl hover:bg-red-500">
