...
<form method="POST" action="{{ route('password.email') }}" class="w-full flex items-center flex-col gap-3 overflow-hidden" novalidate>
  @csrf
...
<div class="field text-[#305582] text-sm md:text-base mt-2">
